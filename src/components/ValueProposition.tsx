    ...
    return (
        <div className="max-w-7xl mx-auto pb-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 md:gap-10 gap-10">
                ...
                >
                    <img src={getImageUrl(valueProposition.svg1.url)} alt="Powerful Yet Elegant" className="w-16 h-16 mb-4 transform hover:scale-110 transition-transform duration-300" />
                ...
                >
                    <img src={getImageUrl(valueProposition.svg2.url)} alt="Secure Yet Easy" className="w-16 h-16 mb-4 transform hover:scale-110 transition-transform duration-300" />
                ...
                >
                    <img src={getImageUrl(valueProposition.svg3.url)} alt="Complex Yet Seamless" className="w-16 h-16 mb-4 transform hover:scale-110 transition-transform duration-300" />
                ...
                >
                    <img src={getImageUrl(valueProposition.svg4.url)} alt="Scalable for Growth" className="w-16 h-16 mb-4 transform hover:scale-110 transition-transform duration-300" />
